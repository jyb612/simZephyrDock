...
class ZDLoggingNode(Node):
    def __init__(self):
        ...
        # self.create_subscription(TrajectorySetpoint, '/fmu/in/trajectory_setpoint', self.trajectory_setpoint_callback, px4_qos)
        ...
        log_filename = f"logs/zd_sim_logging_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
